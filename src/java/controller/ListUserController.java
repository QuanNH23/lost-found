 ...
 * @author phant
 */
@WebServlet(name = "ListUserController", urlPatterns = {"/manage_users"})
public class ListUserController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (session != null) {
            Object success = session.getAttribute("userDeleteSuccess");
            Object error = session.getAttribute("userDeleteError");
